              ...
              <AccordionContent className="bg-blue-200 dark:bg-blue-900 px-4 py-6">
                ...
                <section className="w-full py-12 md:py-24 lg:py-32">
                  <div className="container grid max-w-5xl items-center justify-center gap-8 px-4 md:px-6 lg:grid-cols-2 lg:gap-12 xl:max-w-6xl">
                    <div className="space-y-4 md:space-y-6">
                      <div className="space-y-2">
                        <h3 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl">IAD Informatique</h3>
                        <p className="text-gray-500 dark:text-gray-400">Assistance et services informatiques</p>
                      </div>
                      <div className="flex items-center space-x-4">
                        <p className="text-sm text-gray-500 dark:text-gray-400">Du 15/01/2024 au 23/02/2024</p>
                      </div>
                      <Image
                        src="/img/experience/Logo-iad.png"
                        width={550}
                        height={310}
                        alt="Image"
                        className="mx-auto aspect-video overflow-hidden rounded-xl object-cover object-center sm:w-full"
                      ...
                      <div className="space-y-2">
                        <h4 className="text-lg font-semibold">Activités</h4>
                        <p className="text-gray-500 dark:text-gray-400">
                        Il réalise des missions de conseil, d&apos;audit, de formation, d&apos;installation et de maintenance de logiciels et de matériel
                          </p>
                      </div>
                      <div className="space-y-2">
                        <h4 className="text-lg font-semibold">Environnement technologique de l&apos;entreprise</h4>
                        <p className="text-gray-500 dark:text-gray-400">
                          <ul>
                            <li>Ordinateur portable & fixe</li>
                            <li>Serveur (DMZ et personnel) </li>
                          </ul>
