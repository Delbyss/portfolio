            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="bg-white rounded-full p-2 group">
                  <svg className="h-16 w-16 fill-current text-black hover:text-yellow-500 transition-colors duration-300" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
